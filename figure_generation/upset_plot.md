...
```
    ...
    ##   subgroup  .y.      group1 group2       p  p.adj p.format p.signif method     x
    ##   <fct>     <chr>    <chr>  <chr>    <dbl>  <dbl> <chr>    <chr>    <chr>  <int>
    ## 1 singleton meth_pe… non-hv hv     7.07e-4 0.0028 0.00071  ***      Wilco…     1
    ## 2 clustered meth_pe… non-hv hv     7.39e-2 0.074  0.07387  ns       Wilco…     2
    ## 3 CNL       meth_pe… non-hv hv     2.74e-3 0.0055 0.00274  **       Wilco…     3
    ## 4 TNL       meth_pe… non-hv hv     5.46e-2 0.073  0.05460  ns       Wilco…     4
    ## # ℹ 2 more variables: y <dbl>, stars <chr>
...
```
    ...
    ## Kruskal-Wallis chi-squared = 8.174, df = 3, p-value = 0.04255
...
```
    ...
    ## 
    ## data:  meth_percentage by subgroup
    ## Kruskal-Wallis chi-squared = 1.7164, df = 3, p-value = 0.6333
...
```
    ...
    ## [1] 0.87050 0.12765 0.83595

``` r
p.adjust(c(0.345, 0.6333, 0.619), method='BH')
```

    ## [1] 0.6333 0.6333 0.6333
