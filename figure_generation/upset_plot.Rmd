...
#transcription 
hv_nhv <- compare_means(log2_TPM~HV, table, method='wilcox.test', paired=FALSE)$p.adj*4 
clust <- compare_means(log2_TPM~HV, table %>% filter(clustered == TRUE), method='wilcox.test', paired=FALSE)$p.adj*4 
cnl <- compare_means(log2_TPM~HV, table %>% filter(Nterm == 'C'), method='wilcox.test', paired=FALSE)$p.adj*4 
tnl <- compare_means(log2_TPM~HV, table %>% filter(Nterm == 'T'), method='wilcox.test', paired=FALSE)$p.adj*4 
...
#te_dist
a <- compare_means(te_dist~HV, table, method='wilcox.test', paired=FALSE)$p.adj*4
b <- compare_means(te_dist~HV, table %>% filter(clustered == TRUE), method='wilcox.test', paired=FALSE)$p.adj*4
c <- compare_means(te_dist~HV, table %>% filter(Nterm == 'C'), method='wilcox.test', paired=FALSE)$p.adj*4
d <- compare_means(te_dist~HV, table %>% filter(Nterm == 'T'), method='wilcox.test', paired=FALSE)$p.adj*4
...
#methylation
g <- compare_means(meth_percentage~HV, table, method='wilcox.test', paired=FALSE)$p.adj*4
h <- compare_means(meth_percentage~HV, table %>% filter(clustered == TRUE), method='wilcox.test', paired=FALSE)$p.adj*4
i <- compare_means(meth_percentage~HV, table %>% filter(Nterm == 'C'), method='wilcox.test', paired=FALSE)$p.adj*4
j <- compare_means(meth_percentage~HV, table %>% filter(Nterm == 'T'), method='wilcox.test', paired=FALSE)$p.adj*4
