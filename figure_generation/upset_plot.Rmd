...
pval_table <- pval_table %>% mutate(transcription_stars = case_when(transcription_pval >= 0.05/4 ~ 'n.s.', 
                                                      transcription_pval < .05/4 & transcription_pval >= .01/4 ~ '*',
                                                      transcription_pval < .01/4 & transcription_pval >= .001/4 ~ '**',
                                                      transcription_pval < .001/4 & transcription_pval > 0 ~ '***')) %>%
  mutate(meth_stars = case_when(meth_pval >= 0.05/4 ~ 'n.s.', 
                                meth_pval < .05/4 & meth_pval >= .01/4 ~ '*',
                                meth_pval < .01/4 & meth_pval >= .001/4 ~ '**',
                                meth_pval < .001/4 & meth_pval > 0 ~ '***')) %>%
  mutate(te_stars = case_when(te_dist_pval >= 0.05/4 ~ 'n.s.', 
                                te_dist_pval < .05/4 & te_dist_pval >= .01/4 ~ '*',
                                te_dist_pval < .01/4 & te_dist_pval >= .001/4 ~ '**',
                                te_dist_pval < .001/4 & te_dist_pval > 0 ~ '***'))  
