...
p_upset2 <- upset(table, rev(sets), keep_empty_groups=TRUE, mode='inclusive_intersection', 
  ...
  themes=upset_default_themes(text=element_text(size=8), 
   ...
   base_annotations=list('Inclusive intersection size'=(
     intersection_size(mode='inclusive_intersection', text=list(size=2.5)) + ylab('Set Size'))), 
 # set_sizes=FALSE, 
...
ggsave(filename='C:\\Users\\chand\\Box Sync\\Krasileva_Lab\\Research\\chandler\\Krasileva Lab\\E14\\e14_R\\final_figures\\upset_sig.png', plot=p_upset2, dpi='retina', width=4, height=5.25)
```
