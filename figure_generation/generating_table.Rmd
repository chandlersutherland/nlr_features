...
dif_mean <- read.csv('C:/Users/chand/Box Sync/Krasileva_Lab/Research/chandler/Krasileva Lab/E14/e14_R/CpG_per_gene_met_biorep1.tsv', sep='\t', col.names = c('Chrom', 'Gene', 'meth_percentage', 'cg_count'), skip=1)

dif_merge <- merge(dif_mean, NLR_table, by='Gene', all=TRUE)
```
...
table <- TE %>% subset(select=c('Gene', 'HV', 'log2_TPM', 'meth_percentage', 'te_dist')) %>%
